...
\begin{titlepage}
	\centering
	\vspace*{\fill}
	\Huge \textit{\textbf{Exercices MP/MP$^*$\\ Algèbre Générale}}
	\vspace*{\fill}
\end{titlepage}
...
\begin{exercise}
	...
	\begin{equation*}
		\left(\Z/n\Z, +\right)\to\left(\Z/m\Z, +\right)~\text{?}
	\end{equation*}
\end{exercise}
...
\begin{exercise}
	Trouver tous les morphismes de groupe de $(\Z,+)$ (respectivement $(\Q,+)$) dans
...
\begin{exercise}
	...
	\begin{enumerate}
		...
		\item
		Soit $G$ un sous-groupe fini de $SL_{2}(\R)$. On définit
...
\begin{exercise}
	\phantom{}
	\begin{enumerate}
		\item Soit $\alpha\in\R$ tel que $\alpha\notin\Q$. Montrer que $\Z+\alpha\Z$ est dense dans $\R$. En déduire que $\Z+\alpha\N$ est dense dans $\R$.
		\item
...
\begin{exercise}[Anneau euclidien]
...
\begin{exercise}
	...
	\begin{enumerate}
		...
		divise tous les coefficients de $P_{1}$ ou tous ceux de $Q_{1}$ [Lemme de
		Gauss].
		\item
...
\begin{exercise}
	...
	\begin{enumerate}
		\item
		Soit $P\in\Q[X]$ irréductible sur $\Q[X]$, montrer que $P$ n'a que des
...
\begin{exercise}
	Soit $P\in\Q[X]$ irréductible sur $\Q[X]$, $\alpha\in\C\setminus\Q$ racine de $P$.
	...
	quels sont les coefficients $a_{k}$ tels que $a_{k}\in\Q$.
\end{exercise}
...
\begin{exercise}
	...
	$\Bigl(\Z/p\Z,+,\times\Bigr)$. On dit que $\overline{x}\in\mathbb{F}_{p}^{*}$ est un
	résidu quadratique si et seulement si il existe $\overline{y}\in\mathbb{F}_{p}^{*}$ tel
	que $\overline{x}=\overline{y}^{2}$. On note $R$ l'ensemble des résidus quadratiques.
	\begin{enumerate}
		\item
		...
		1[4]$. On pourra montrer que $\overline{-1}\in R$.
		\item
...
\begin{exercise}
	Soit $p$ premier différent de 2, $k$ diviseur premier de $2^{p}-1$. Montrer que $k\mod 1[2p]$.
\end{exercise}
\end{document}