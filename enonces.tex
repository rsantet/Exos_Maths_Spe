...
\begin{exercise}
	...
	$$\Vert (a_{i,j})_{1\leqslant i,j\leqslant n}\Vert=\max\limits_{1\leqslant i,j\leqslant n}$$. Montrer que $G=GL_{n}(\C)$.
\end{exercise}
...
\begin{exercise}[Théorème de Perron-Frobenius]
	...
	\begin{enumerate}
		...
		\item Soit $\lambda\in\Sp_{\lambda}(A)$ et $V\in\M_{n,1}(\C)$ tel que $\Vert V\Vert_{1}=1$ et $AV=\lambda V$. Montrer que $\vert AV\vert\leqslant A\vert V\vert$, en déduire que $\vert\lambda\vert\leqslant r_{0}$.
