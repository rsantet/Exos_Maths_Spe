...
\begin{proof}
	...
	\begin{enumerate}
		...
		Donc $\sum w_{n}$ est une série télescopique convergente. Comme $t\mapsto\frac{1}{t^{\alpha}}$ est décroissante, on a 
		...
		Si $0<\alpha<1$, $\lim\limits_{n\to+\infty}R_{n}^{1-\alpha}=0$ donc $\sum \alpha_{n}$ est une série télescopique convergente et de même que précédemment, on a 
		...
		où $\ln(R_{n})\xrightarrow[n\to+\infty]{}-\infty$. Donc $\sum \alpha_{n}$ est une série télescopique divergente. De plus 
